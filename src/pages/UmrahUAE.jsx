...
import {
  UMRAH_UAE_TRAVEL_OPTIONS,
  UMRAH_UAE_FEATURES,
  UMRAH_UAE_TESTIMONIALS
} from '@/data'
      ...
      <div className="relative pt-20 sm:pt-32 pb-12 sm:pb-20 text-center overflow-hidden" style={{ background: 'var(--dark-bg)' }}>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-8">
            <a
              href="https://wa.me/918110082222?text=I%20want%20details%20about%20Umrah%20from%20UAE"
              target="_blank"
      ...
      <section className="py-20" style={{ background: 'var(--sand)' }}>
        <div className="max-w-6xl mx-auto px-6">
          <SectionHeader
            ...
            title="Three Ways to Reach the Haramain"
            subtitle="Choose the travel style that suits your schedule, budget, and comfort level."
          />
          <div className="grid lg:grid-cols-3 gap-8">
            {UMRAH_UAE_TRAVEL_OPTIONS.map((t, i) => (
              <div
                key={t.title}
                className="glass-card-light p-8 rounded-2xl reveal relative overflow-hidden"
              ...
              >
                  ...
                  {t.features.map((f) => (
                    <li key={f} className="flex items-center gap-2 text-xs font-body" style={{ color: 'rgba(26,26,26,0.7)' }}>
                      <span
                        ...
                        style={{ background: 'rgba(201,168,76,0.15)', color: 'var(--gold)', fontSize: '9px', fontWeight: 'bold' }}
                      >
                        ✓
                      </span>
                      {f}
                ...
                <a
                  href="https://wa.me/918110082222?text=I%20want%20details%20on%20Umrah%20from%20UAE"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div className="glass-card rounded-3xl p-8 md:p-12 reveal">
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <a
                  href="https://wa.me/918110082222?text=I%20want%20details%20on%20the%20Weekend%20Executive%20Umrah%20from%20UAE"
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <div className="relative h-72 lg:h-full min-h-87.5 rounded-2xl overflow-hidden shadow-2xl">
      ...
      <section className="py-20" style={{ background: 'var(--pearl)' }}>
        <div className="max-w-6xl mx-auto px-6">
          <SectionHeader
            ...
            title="The UAE Crescent Advantage"
            subtitle="Our UAE-based operations give you unmatched convenience, speed, and service quality."
          />
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {UMRAH_UAE_FEATURES.map((f, i) => (
              <div
                key={f.title}
                className="glass-card-light p-6 rounded-2xl reveal flex gap-4 items-start"
      ...
      <section className="py-20" style={{ background: 'var(--sand)' }}>
        <div className="max-w-6xl mx-auto px-6">
          <SectionHeader
            ...
            title="UAE Pilgrims Speak"
            subtitle="Join hundreds of UAE-based families who have made their Umrah dream a reality with Crescent."
          />
          <div className="grid md:grid-cols-3 gap-6">
            {UMRAH_UAE_TESTIMONIALS.map((t, i) => (
              <div
                key={i}
                className="glass-card-light p-7 rounded-2xl reveal border-t-4"
                style={{ borderTopColor: 'var(--gold)', transitionDelay: `${i * 0.1}s` }}
              >
                ...
                <p className="font-heading text-base italic mb-5 leading-relaxed" style={{ color: 'rgba(26,26,26,0.75)' }}>
                  "{t.text}"
                </p>
      ...
      <section className="py-16 text-center" style={{ background: 'linear-gradient(135deg, var(--emerald), #0e5c46)' }}>
        <div className="max-w-2xl mx-auto px-6 reveal">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="https://wa.me/918110082222?text=I%20want%20to%20book%20Umrah%20from%20UAE"
              target="_blank"
              rel="noopener noreferrer"
