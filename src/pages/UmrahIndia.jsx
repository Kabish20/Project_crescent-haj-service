...
import {
  UMRAH_INDIA_FEATURES,
  UMRAH_INDIA_INCLUSIONS,
  DEPARTURE_CITIES,
  UMRAH_INDIA_TESTIMONIALS
} from '@/data'
      ...
      <div className="relative pt-20 sm:pt-32 pb-12 sm:pb-20 text-center overflow-hidden" style={{ background: 'var(--dark-bg)' }}>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-8">
            <a
              href="https://wa.me/918110082222?text=I%20want%20details%20about%20Umrah%20from%20India"
              target="_blank"
      ...
      <section className="py-6" style={{ background: 'linear-gradient(90deg, var(--emerald) 0%, #0e5c46 50%, var(--emerald) 100%)' }}>
        <div className="max-w-7xl mx-auto px-6 flex flex-wrap justify-center gap-0">
          {[
            ...
            <div key={s.l} className="flex-1 min-w-35 text-center px-4 py-3 border-r last:border-r-0" style={{ borderColor: 'rgba(255,255,255,0.1)' }}>
      ...
      <section className="py-20" style={{ background: 'var(--sand)' }}>
        <div className="max-w-6xl mx-auto px-6">
          <SectionHeader
            ...
            title="Designed for Indian Pilgrims"
            subtitle="Everything you need, thoughtfully planned with the Indian pilgrim's comfort and culture in mind."
          />
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {UMRAH_INDIA_FEATURES.map((f, i) => (
      ...
      <section className="py-20" style={{ background: 'var(--pearl)' }}>
        <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-12">
          ...
          <div className="reveal-left">
            <span
              className="inline-block text-xs font-body font-bold uppercase tracking-widest px-3 py-1 rounded-full mb-5"
            ...
            <div className="grid grid-cols-1 gap-2">
              {UMRAH_INDIA_INCLUSIONS.map((item, i) => (
                <div key={i} className="flex items-center gap-3 py-2.5 px-4 rounded-lg" style={{ background: i % 2 === 0 ? 'rgba(13,74,58,0.04)' : 'transparent' }}>
                  <span
                    ...
                    style={{ background: 'linear-gradient(135deg, var(--gold), var(--gold-light))', fontSize: '10px', color: '#1a0e00', fontWeight: 'bold' }}
                  >
                    ✓
                  </span>
              ...
              {DEPARTURE_CITIES.map((d, i) => (
                <div key={i} className="glass-card-light p-4 rounded-xl flex justify-between items-center">
                  ...
                  <div className="text-right">
                    ...
                    <div className="mt-1">
                      <a
                        href={`https://wa.me/918110082222?text=Enquiry%20for%20Umrah%20from%20${d.city}`}
                        target="_blank"
                        rel="noopener noreferrer"
      ...
      <section className="py-20" style={{ background: 'var(--dark-bg)' }}>
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {UMRAH_INDIA_TESTIMONIALS.map((t, i) => (
              <div key={i} className="glass-card p-7 rounded-2xl reveal" style={{ transitionDelay: `${i * 0.1}s` }}>
                ...
                <p className="font-heading text-base italic mb-5 leading-relaxed" style={{ color: 'rgba(250,248,243,0.8)' }}>
                  "{t.text}"
                </p>
      ...
      <section className="py-16 text-center" style={{ background: 'linear-gradient(135deg, var(--emerald), #0e5c46)' }}>
        <div className="max-w-2xl mx-auto px-6 reveal">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="https://wa.me/918110082222?text=I%20want%20details%20about%20Umrah%20packages%20from%20India"
              target="_blank"
              rel="noopener noreferrer"
