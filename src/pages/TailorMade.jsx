...
import { SectionHeader, GoldDivider } from '@/components/common'
import { useScrollReveal } from '@/hooks'
import { CONTACT_INFO } from '@/constants'
import { TAILOR_MADE_BENEFITS, HOTEL_OPTIONS } from '@/data'
            ...
            {HOTEL_OPTIONS.map((h, i) => (
              <div key={h.name} className="glass-card-light rounded-xl p-5 reveal flex gap-4 items-start" style={{ transitionDelay: `${i * 0.05}s` }}>
                ...
                <div>
                  ...
                  <span className="inline-block text-xs font-bold px-2 py-0.5 rounded" style={{ background: 'rgba(201,168,76,0.1)', color: 'var(--gold)' }}>
                    {h.highlight}
                  </span>
                </div>
              </div>
          ...
          <div className="glass-card rounded-2xl p-8 md:p-10 reveal">
            ...
            <div className="mt-5">
              ...
              <textarea
                name="notes"
                rows={4}
                placeholder="Elderly pilgrim, wheelchair access, dietary requirements, private guide, Ramadan nights, specific Ziyarat sites..."
                value={form.notes}
                onChange={handleChange}
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-4">
              <a
                href={`https://wa.me/918110082222?text=${encodeURIComponent(whatsappMsg)}`}
                target="_blank"
              ...
              <a
                ...
                className="btn-ghost flex-1 py-4 rounded-full font-body font-bold text-sm text-center"
              >
