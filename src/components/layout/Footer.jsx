...
export default function Footer() {
  return (
    <footer style={{ background: 'var(--dark-bg)', borderTop: '1px solid rgba(201,168,76,0.15)' }}>
      {/* Top CTA Banner */}
      <div
        className="py-12 text-center islamic-pattern relative overflow-hidden"
        style={{ background: 'linear-gradient(135deg,var(--emerald) 0%,#0e5c46 50%,var(--emerald) 100%)' }}
      >
      ...
      {/* Trust Badges */}
      <div className="bg-linear-to-r from-emerald-900/30 to-emerald-800/30 py-8 px-4 sm:px-6 border-y border-emerald-700/20">
          ...
          <div className="mt-7">
            ...
            <div className="flex items-center gap-2.5">
              <a
                ...
                aria-label="Crescent Haj Service on YouTube"
                title="YouTube"
              >
              ...
              <a
                href="https://www.instagram.com/crescenthaj/?hl=en"
                target="_blank"
                rel="noopener noreferrer"
                className="footer-social"
                aria-label="Crescent Haj Service on Instagram"
                title="Instagram"
              >
              ...
              <a
                href="https://www.facebook.com/CrescentHaj/"
                target="_blank"
                rel="noopener noreferrer"
                className="footer-social"
                aria-label="Crescent Haj Service on Facebook"
                title="Facebook"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path d="M13.5 21v-8h2.8l.4-3h-3.2V8.1c0-.9.3-1.6 1.7-1.6h1.8V3.8c-.3 0-1.3-.1-2.5-.1-2.5 0-4.2 1.5-4.2 4.3V10H7.5v3H10v8h3.5Z" />
                </svg>
              </a>
            </div>
          </div>
            ...
            <div className="flex gap-3">
              ...
              <div className="text-sm font-body leading-relaxed" style={{ color: 'rgba(250,248,243,0.55)' }}>
                {CONTACT_INFO.offices.map((office, idx) => (
                  <p key={office.label} className={idx > 0 ? 'mt-3' : ''}>
                    <strong style={{ color: 'rgba(250,248,243,0.8)' }}>{office.city}, {office.country}</strong>
                    <br />
                    {office.label.replace(' Office', '').replace(' Operations', '')}
                    <br />
                    {office.value}
                  </p>
                ))}
      ...
      {/* Bottom Bar */}
      <div
        className="border-t py-6 px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-3 text-center sm:text-left"
