export default function WhatsAppButton() {
  return (
    ...
    >
      ...
      <span className="absolute -top-1 -right-1 w-5 h-5 rounded-full flex items-center justify-center text-xs font-bold text-white" style={{background:'var(--gold)'}}>●</span>
    </a>
  )
}
